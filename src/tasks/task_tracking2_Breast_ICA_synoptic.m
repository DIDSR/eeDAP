...
%description
%pathologist drive Breast_ICA_synoptic study
%do global registration after study

%task column
%tracking2_Breast_ICA_synoptic,TaskID,TaskOrder,Slot
    ...
    switch calling_function
        ...
        case 'Load_Input_File' % Read in the taskinfo
           ...
           handles = guidata(hObj);
            ...
            taskinfo.question5 = '5.If applicable, perform a mitotic count in 10HPF and enter numerical value only (example: 3 denotes 3 mitoses per 10HPF; N/A if not applicable)';
            ...
            taskinfo.question2result=zeros(1,7);
            taskinfo.question3result=zeros(1,4);
            taskinfo.question4result=zeros(1,4);
          ...
          % Recoding status
           ...
           handles.questionText2 = uicontrol(...
            ...
            handles.question2Checkbox2 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.675,0.55,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
            ...
            handles.question2Checkbox3 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.75,0.55,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox3_Callback, ...
                'String', 'Micropapillary');  
            ...
            handles.question2Checkbox4 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.825,0.55,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox4_Callback, ...
                'String', 'Metaplastic');  
            % Question 2 checkbox5
            handles.question2Checkbox5 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.5,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox5_Callback, ...
                'String', 'Micro-invasive');  
            % Question 2 checkbox6
            handles.question2Checkbox6 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.675,0.5,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox6_Callback, ...
                'String', 'Mucinous');            
            % Question 2 checkbox7
            handles.question2Checkbox7 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.75,0.5,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox7_Callback, ...
                'String', 'N/A');    
           ...
           handles.questionText3 = uicontrol(...
            ...
            handles.question3Checkbox2 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.675,0.425,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
            ...
            handles.question3Checkbox3 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.75,0.425,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
            ...
            handles.question3Checkbox4 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.825,0.425,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
           ...
           handles.questionText4 = uicontrol(...
            ...
            handles.question4Checkbox2 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.675,0.325,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
            ...
            handles.question4Checkbox3 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.75,0.325,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
            ...
            handles.question4Checkbox4 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.825,0.325,0.075,0.05], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
        ...
        case {'NextButtonPressed', ...
            ...
            delete(handles.question2Checkbox5);
            delete(handles.question2Checkbox6);
            delete(handles.question2Checkbox7);
            ...
            handles = rmfield(handles, 'question2Checkbox5');
            handles = rmfield(handles, 'question2Checkbox6');
            handles = rmfield(handles, 'question2Checkbox7');
        ...
        case 'exportOutput' % export current task information and reuslt
            if taskinfo.currentWorking ==1 % write finish task in current study
                fprintf(myData.fid, [...
                    ...
                    num2str(taskinfo.question2result(5)),',',...
                    num2str(taskinfo.question2result(6)),',',...
                    num2str(taskinfo.question2result(7)),',',...
...
try
     ...
     set(handles.question2Checkbox5,'visible','on','Enable','on');
     set(handles.question2Checkbox6,'visible','on','Enable','on');
     set(handles.question2Checkbox7,'visible','on','Enable','on');
...
function question2Checkbox5_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question2time);
    taskinfo.question2time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question2result(5)=1;
        taskinfo.question2checkedBox{recordLength+1} = 'B5Check';
    else
        taskinfo.question2result(5)=0;
        taskinfo.question2checkedBox{recordLength+1} = 'B5Uncheck';
    end
    taskinfo.done2(3)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question2Checkbox6_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question2time);
    taskinfo.question2time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question2result(6)=1;
        taskinfo.question2checkedBox{recordLength+1} = 'B6Check';
    else
        taskinfo.question2result(6)=0;
        taskinfo.question2checkedBox{recordLength+1} = 'B6Uncheck';
    end
    taskinfo.done2(3)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question2Checkbox7_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question2time);
    taskinfo.question2time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question2result(7)=1;
        taskinfo.question2checkedBox{recordLength+1} = 'B7Check';
    else
        taskinfo.question2result(7)=0;
        taskinfo.question2checkedBox{recordLength+1} = 'B7Uncheck';
    end
    taskinfo.done2(3)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
try
     ...
     set(handles.question2Checkbox5,'visible','off','Enable','off');
     set(handles.question2Checkbox6,'visible','off','Enable','off');
     set(handles.question2Checkbox7,'visible','off','Enable','off');
