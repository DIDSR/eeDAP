    ...
    switch calling_function
        ...
        case 'Load_Input_File' % Read in the taskinfo
           ...
           handles = guidata(hObj);
            ...
            taskinfo.question1 = '1.What is your main diagnosis? (Binary response)';
            taskinfo.question2 = '2.If applicable, classify the metastasis.(Multiple choice)';
            taskinfo.question3 = '3.If applicable, state the location of metastasis; if multiple deposits are seen, state the location of the largest deposit.(Multiple choice)';
            taskinfo.question4 = '4.If applicable, how many metastatic deposits can you identify. (Multiple choice)';
            taskinfo.question5 = '5.If applicable, report the size of the largest deposit for macro- and micrometastasis in mm; use N/A if not applicable.';
            ...
            taskinfo.question3result=zeros(1,6);
            taskinfo.question4result=zeros(1,5);
            if length(taskinfo.desc)>4 %not sure
          ...
          % Recoding status
           ...
           handles.questionText1 = uicontrol(...
            ...
            handles.question1panel = uibuttongroup('Parent',handles.task_panel,...
                'Position',[0.6,0.625,0.25,0.05],...
                'visible','off');
            % Question 1 radio button 1    
            handles.question1Radiobutton1 = uicontrol(...
                ...
                'Enable','off',...
                'visible','off',...
                'Tag', 'question1Radiobutton1', ...
                'String', 'Benign');
            % Question 1 radio button 2  
            handles.question1Radiobutton2 = uicontrol(...
                'Parent', handles.question1panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                ...
                'Enable','off',...
                'visible','off',...
                'Tag', 'question1Radiobutton2', ...
                'String', 'Metastasis');
            set(handles.question1panel, ...
                'SelectionChangeFcn', @question1Radiobutton_Callback, ...
                'SelectedObject', []);
           ...
           handles.questionText2 = uicontrol(...
            ...
            handles.question2Checkbox1 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.55,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox1_Callback, ...
                'String', 'Isolated tumor cells');
            ...
            handles.question2Checkbox2 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.75,0.55,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox2_Callback, ...
                'String', 'Micrometastasis');  
            ...
            handles.question2Checkbox3 = uicontrol(...
                ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.525,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question2Checkbox3_Callback, ...
                'String', 'Macrometastasis');  
           ...
           handles.questionText3 = uicontrol(...
                    ...
                    'Tag', 'questionText3');
            % Question 3 checkbox1
            handles.question3Checkbox1 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.45,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question3Checkbox1_Callback, ...
                'String', 'subcapsular');
            % Question 3 checkbox2
            handles.question3Checkbox2 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.7,0.45,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question3Checkbox2_Callback, ...
                'String', 'intranodal');  
            % Question 3 checkbox3
            handles.question3Checkbox3 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question3Checkbox3_Callback, ...
                'String', 'extranodal');  
            % Question 3 checkbox4
            handles.question3Checkbox4 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.425,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question3Checkbox4_Callback, ...
                'String', 'LVI'); 
            % Question 3 checkbox5
            handles.question3Checkbox5 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.7,0.425,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question3Checkbox5_Callback, ...
                'String', 'LN entirely replaced'); 
            % Question 3 checkbox6
            handles.question3Checkbox6 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.8,0.425,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question3Checkbox6_Callback, ...
                'String', 'N/A');              
           ...
           handles.questionText4 = uicontrol(...
                    ...
                    'Tag', 'questionText4');
            % Question 4 checkbox1
            handles.question4Checkbox1 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.35,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question4Checkbox1_Callback, ...
                'String', '1');
            % Question 4 checkbox2
            handles.question4Checkbox2 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.7,0.35,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question4Checkbox2_Callback, ...
                'String', '2');  
            % Question 4 checkbox3
            handles.question4Checkbox3 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.8,0.35,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question4Checkbox3_Callback, ...
                'String', '3');  
            % Question 4 checkbox4
            handles.question4Checkbox4 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.6,0.325,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question4Checkbox4_Callback, ...
                'String', 'LN entirely replaced');    
            % Question 4 checkbox5
            handles.question4Checkbox5 = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'left', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', handles.myData.settings.BG_color, ...
                'Position', [0.7,0.325,0.1,0.025], ...
                'Style', 'checkbox', ...
                'Enable','off',...
                'visible','off',...
                'Callback',@question4Checkbox5_Callback, ...
                'String', 'N/A');       
           ...
           handles.questionText5 = uicontrol(...
                    ...
                    'Tag', 'questionText5');
            % Question 5 comment
           handles.question5Comment = uicontrol(...
                'Parent', handles.task_panel, ...
                'FontSize', handles.myData.settings.FontSize, ...
                'Units', 'normalized', ...
                'HorizontalAlignment', 'center', ...
                'ForegroundColor', handles.myData.settings.FG_color, ...
                'BackgroundColor', [.95, .95, .95], ...
                'Position', [0.6,0.2,0.275,0.075], ...
                'Style', 'edit', ...
                'Enable','off',...
                'visible','off',...
                'Tag', 'commentResult5', ...
                'Callback', @question5Comment_Callback);
        ...
        case {'NextButtonPressed', ...
            ...
            delete(handles.question1Radiobutton1);
            delete(handles.question1Radiobutton2);
            ...
            delete(handles.question3Checkbox1);
            delete(handles.question3Checkbox2);
            delete(handles.question3Checkbox3);
            delete(handles.question3Checkbox4);
            delete(handles.question3Checkbox5);
            delete(handles.question3Checkbox6);
            delete(handles.questionConfidence3);
            delete(handles.questionText4);
            delete(handles.question4Checkbox1);
            delete(handles.question4Checkbox2);
            delete(handles.question4Checkbox3);
            delete(handles.question4Checkbox4);
            delete(handles.question4Checkbox5);
            delete(handles.questionConfidence4);
            delete(handles.questionText5);
            delete(handles.question5Comment);
            ...
            handles = rmfield(handles, 'question1Radiobutton1');
            handles = rmfield(handles, 'question1Radiobutton2');
            ...
            handles = rmfield(handles, 'question3Checkbox1');
            handles = rmfield(handles, 'question3Checkbox2');
            handles = rmfield(handles, 'question3Checkbox3');
            handles = rmfield(handles, 'question3Checkbox4');
            handles = rmfield(handles, 'question3Checkbox5');
            handles = rmfield(handles, 'question3Checkbox6');
            handles = rmfield(handles, 'questionConfidence3');
            handles = rmfield(handles, 'questionText4');
            handles = rmfield(handles, 'question4Checkbox1');
            handles = rmfield(handles, 'question4Checkbox2');
            handles = rmfield(handles, 'question4Checkbox3');
            handles = rmfield(handles, 'question4Checkbox4');
            handles = rmfield(handles, 'question4Checkbox5');
            handles = rmfield(handles, 'questionConfidence4');
            handles = rmfield(handles, 'questionText5');
            handles = rmfield(handles, 'question5Comment');
        ...
        case 'exportOutput' % export current task information and reuslt
            if taskinfo.currentWorking ==1 % write finish task in current study
                fprintf(myData.fid, [...
                    ...
                    num2str(taskinfo.question3result(1)),',',...
                    num2str(taskinfo.question3result(2)),',',...
                    num2str(taskinfo.question3result(3)),',',...
                    num2str(taskinfo.question3result(4)),',',...
                    num2str(taskinfo.question3result(5)),',',...
                    num2str(taskinfo.question3result(6)),',',...
                    taskinfo.confidence3,',',...    
                    num2str(taskinfo.question4result(1)),',',...
                    num2str(taskinfo.question4result(2)),',',...
                    num2str(taskinfo.question4result(3)),',',...
                    num2str(taskinfo.question4result(4)),',',...
                    num2str(taskinfo.question4result(5)),',',...
...
try
     ...
     start(handles.tmr);
     set(handles.question1panel,'visible','on');    
     set(handles.questionText1,'visible','on','Enable','on');
     set(handles.question1Radiobutton1,'visible','on','Enable','on');
     set(handles.question1Radiobutton2,'visible','on','Enable','on');
     ...
     set(handles.question3Checkbox1,'visible','on','Enable','on');
     set(handles.question3Checkbox2,'visible','on','Enable','on');
     set(handles.question3Checkbox3,'visible','on','Enable','on');
     set(handles.question3Checkbox4,'visible','on','Enable','on');
     set(handles.question3Checkbox5,'visible','on','Enable','on');
     set(handles.question3Checkbox6,'visible','on','Enable','on');
     set(handles.questionConfidence3,'visible','on','Enable','on');
     set(handles.questionText4,'visible','on','Enable','on');
     set(handles.question4Checkbox1,'visible','on','Enable','on');
     set(handles.question4Checkbox2,'visible','on','Enable','on');
     set(handles.question4Checkbox3,'visible','on','Enable','on');
     set(handles.question4Checkbox4,'visible','on','Enable','on');
     set(handles.question4Checkbox5,'visible','on','Enable','on');
     set(handles.questionConfidence4,'visible','on','Enable','on');
     set(handles.questionText5,'visible','on','Enable','on'); 
     set(handles.question5Comment,'visible','on','Enable','on');
...
% question 1
% question 4
function question1Radiobutton_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    ...
    switch taskinfo.button_desc
        case 'question1Radiobutton1'
            taskinfo.question1result = 'Benign';
            taskinfo.question1checkedBox{recordLength+1} = 'Benign';
        case 'question1Radiobutton2'
            taskinfo.question1result = 'Metastasis';
            taskinfo.question1checkedBox{recordLength+1} = 'Metastasis';
    end
    taskinfo.done2(1)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
% question 3
function question3Checkbox1_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question3time);
    taskinfo.question3time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question3result(1)=1;
        taskinfo.question3checkedBox{recordLength+1} = 'B1Check';
    else
        taskinfo.question3result(1)=0;
        taskinfo.question3checkedBox{recordLength+1} = 'B1Uncheck';
    end
    taskinfo.done2(5)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question3Checkbox2_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question3time);
    taskinfo.question3time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question3result(2)=1;
        taskinfo.question3checkedBox{recordLength+1} = 'B2Check';
    else
        taskinfo.question3result(2)=0;
        taskinfo.question3checkedBox{recordLength+1} = 'B2Uncheck';
    end
    taskinfo.done2(5)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question3Checkbox3_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question3time);
    taskinfo.question3time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question3result(3)=1;
        taskinfo.question3checkedBox{recordLength+1} = 'B3Check';
    else
        taskinfo.question3result(3)=0;
        taskinfo.question3checkedBox{recordLength+1} = 'B3Uncheck';
    end
    taskinfo.done2(5)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question3Checkbox4_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question3time);
    taskinfo.question3time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question3result(4)=1;
        taskinfo.question3checkedBox{recordLength+1} = 'B4Check';
    else
        taskinfo.question3result(4)=0;
        taskinfo.question3checkedBox{recordLength+1} = 'B4Uncheck';
    end
    taskinfo.done2(5)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question3Checkbox5_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question3time);
    taskinfo.question3time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question3result(5)=1;
        taskinfo.question3checkedBox{recordLength+1} = 'B5Check';
    else
        taskinfo.question3result(5)=0;
        taskinfo.question3checkedBox{recordLength+1} = 'B5Uncheck';
    end
    taskinfo.done2(5)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question3Checkbox6_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question3time);
    taskinfo.question3time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question3result(6)=1;
        taskinfo.question3checkedBox{recordLength+1} = 'B6Check';
    else
        taskinfo.question3result(6)=0;
        taskinfo.question3checkedBox{recordLength+1} = 'B6Uncheck';
    end
    taskinfo.done2(5)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
% question 4
function question4Checkbox1_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question4time);
    taskinfo.question4time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question4result(1)=1;
        taskinfo.question4checkedBox{recordLength+1} = 'B1Check';
    else
        taskinfo.question4result(1)=0;
        taskinfo.question4checkedBox{recordLength+1} = 'B1Uncheck';
    end
    taskinfo.done2(7)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question4Checkbox2_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question4time);
    taskinfo.question4time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question4result(2)=1;
        taskinfo.question4checkedBox{recordLength+1} = 'B2Check';
    else
        taskinfo.question4result(2)=0;
        taskinfo.question4checkedBox{recordLength+1} = 'B2Uncheck';
    end
    taskinfo.done2(7)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question4Checkbox3_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question4time);
    taskinfo.question4time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question4result(3)=1;
        taskinfo.question4checkedBox{recordLength+1} = 'B3Check';
    else
        taskinfo.question4result(3)=0;
        taskinfo.question4checkedBox{recordLength+1} = 'B3Uncheck';
    end
    taskinfo.done2(7)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question4Checkbox4_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question4time);
    taskinfo.question4time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question4result(4)=1;
        taskinfo.question4checkedBox{recordLength+1} = 'B4Check';
    else
        taskinfo.question4result(4)=0;
        taskinfo.question4checkedBox{recordLength+1} = 'B4Uncheck';
    end
    taskinfo.done2(7)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
function question4Checkbox5_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question4time);
    taskinfo.question4time{recordLength+1} = datestr(clock,30);
    if (get(hObj,'Value') == get(hObj,'Max'))
        taskinfo.question4result(5)=1;
        taskinfo.question4checkedBox{recordLength+1} = 'B5Check';
    else
        taskinfo.question4result(5)=0;
        taskinfo.question4checkedBox{recordLength+1} = 'B5Uncheck';
    end
    taskinfo.done2(7)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
...
% question 5
function question5Comment_Callback(hObj, eventdata)
    handles = guidata(findobj('Tag','GUI'));
    taskinfo = handles.myData.tasks_out{handles.myData.iter};
    recordLength = length(taskinfo.question5time);
    taskinfo.question5time{recordLength+1} = datestr(clock,30);
    taskinfo.question5checkedBox{recordLength+1} = 'Edit';
    % Pack the results
    taskinfo.question5result = get(handles.question5Comment, 'String');
    taskinfo.done2(9)=1;
    tdone2=sum(taskinfo.done2);
    if tdone2==12
        set(handles.goToPage3,'Enable','on');
...
try
     ...
     set(handles.question1panel,'visible','off'); 
     set(handles.question1Radiobutton1,'visible','off','Enable','off');
     set(handles.question1Radiobutton2,'visible','off','Enable','off');
     ...
     set(handles.question3Checkbox1,'visible','off','Enable','off');
     set(handles.question3Checkbox2,'visible','off','Enable','off');
     set(handles.question3Checkbox3,'visible','off','Enable','off');
     set(handles.question3Checkbox4,'visible','off','Enable','off');
     set(handles.question3Checkbox5,'visible','off','Enable','off');
     set(handles.question3Checkbox6,'visible','off','Enable','off');
     set(handles.questionConfidence3,'visible','off','Enable','off');
     set(handles.questionText4,'visible','off','Enable','off');
     set(handles.question4Checkbox1,'visible','off','Enable','off');
     set(handles.question4Checkbox2,'visible','off','Enable','off');
     set(handles.question4Checkbox3,'visible','off','Enable','off');
     set(handles.question4Checkbox4,'visible','off','Enable','off');
     set(handles.question4Checkbox5,'visible','off','Enable','off');
     set(handles.questionConfidence4,'visible','off','Enable','off');
     set(handles.questionText5,'visible','off','Enable','off');
     set(handles.question5Comment,'visible','off','Enable','off');
