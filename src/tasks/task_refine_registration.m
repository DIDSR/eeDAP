...
try
    ...
    switch calling_function
        case {'Refine_Register_Button_Callback', ...
            ...
            % Guide text 
            desc = [...
                'Use joystick: register eyepiece to center of WSI. ', ...
                'Click Refine Registration and Next. ', ...
                'On return, you should be close enough to the correct location ', ...
                'to manually register with joystick.'];
...
function switchWSI_Callback(hObj, eventdata)
    ...
    if taskinfo.highMag == 1 
       ...
       set(handles.guideText,'String','Please switch to high magnification to complete refine registration');
       taskinfo.highMag = 0;
       ...
       desc = [...
           ...
           'On return, you should be close enough to the correct location ', ...
           'to manually register with joystick.'];
       set(handles.guideText,'String',desc);
       taskinfo.highMag = 1;
