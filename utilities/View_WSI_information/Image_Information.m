...
% Last Modified by GUIDE v2.5 23-Apr-2019 09:53:47
...
% --- Executes on button press in loadWSI.
function loadWSI_Callback(hObject, eventdata, handles)
% hObject    handle to loadWSI (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
try
    %--------------------------------------------------------------------------
